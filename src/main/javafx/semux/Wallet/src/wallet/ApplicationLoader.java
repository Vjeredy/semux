...
public class ApplicationLoader extends Application {
    ...
    public void start(Stage stage) throws Exception {
        //Dont need to add new account and list if loaded from preloader, just for example
        ...
        Scene sceneTransactions = new Scene(FXMLLoader.load(getClass()
                .getResource("scenes/transactions/TransactionsFXML.fxml")), INIT_MAIN_SCENE_WIDTH, INIT_MAIN_SCENE_HEIGHT);
