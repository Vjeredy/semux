...
public class WindowSizeStateWatcher {
    ...
    /**
     * Watcher constructor. Changes stage window size, state, position accordingly to the previous stage window parameters.
     * @param newStage window size, state, position of this stage will be changed to previous stage window parameters
     * @param oldStage window size, state, position of this stage will be transferred to new stage
     */
     ...
     * @param stage stage that got new scene
     * @param wasMaximized window size, state of stage before scene change
     * @param previousWidth stage width before scene change
     * @param previousHeight stage height before scene change
     */
