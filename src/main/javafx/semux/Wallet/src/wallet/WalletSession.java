...
public class WalletSession {
    ...
    /**
     * @param accountLoaded current account loaded from application preloader
     * @param accountsListLoaded list of all accounts
     */
     ...
     * @param newAccount account selected as current
     */
